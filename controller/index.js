...
const init_controller = () => {
    ...
    size_controller();
    buttons_add(new Button(controller.enter.dst, undefined, undefined, () => { console.log("enter"); }));
    buttons_add(new Button(controller.exit.dst, undefined, undefined, () => { console.log("exit"); }));
    buttons_add(new Button(controller.up.dst, undefined, undefined, () => { console.log("up"); }));
    buttons_add(new Button(controller.down.dst, undefined, undefined, () => { console.log("down"); }));
    buttons_add(new Button(controller.left.dst, undefined, undefined, () => { console.log("left"); }));
    buttons_add(new Button(controller.right.dst, undefined, undefined, () => { console.log("right"); }));
};
